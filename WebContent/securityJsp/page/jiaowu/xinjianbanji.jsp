...
<script type="text/javascript">
	...
	$(document).ready(function() {
		init();
		if(<%=flag%>){
			$.post("getClassSByClassCode", {classCode :"<%=classCode%>"},
											function(result) {
												tuitionChange(result.tuitionType);
												tuitionDivChange(result.tuitionType);
												loadTimigWeekday(result.weekString
														.split(";"));
												var url = 'getAllCourses?courseTypeCode='
			...
			<div style="width: 60%; margin: 10px auto;">
				<div>
					<img src="../../../style/image/Folder.gif"
						...
						style="vertical-align: middle;">新建班级</span><input type="hidden"
						name="classCode" value="<%=classCode%>" />
				</div>
				<hr />
				<div class="divRow">
					<div style="width: 100px; float: left">
						<label for="schoolCode">&nbsp;校&nbsp;区</label>
					</div>
					<div style="display: inline">
						<input id="schoolCode" class="easyui-combobox" name="schoolCode"
							data-options="valueField:'schoolCode',textField:'schoolName',url:'getAllSchools',panelHeight:'auto',editable:false" />
					</div>
				</div>
				<div class="divRow">
					<div style="width: 100px; float: left">
						<label for="nameM">班级名称</label>
					</div>
					<div style="display: inline">
						<input type="text" name="nameM" data-options="required:true"
				...
				<div class="divRow">
					...
					<div style="display: inline">
						<input id="courseTypeCode" class="easyui-combobox"
							style="width: 200px;" data-options="required:true"
							name="courseTypeCode" /> &nbsp; <input style="width: 200px;"
				...
				<div class="divRow" id="tuitionDiv">
					<div style="width: 100px; float: left">
						<label for="tuitionType">收费模式</label>
					</div>
					<div style="display: inline">

						<span id="tuitionSpan1"> <input type="radio"
							style="width: 20px" id="tuitionType1" checked="checked"
							onclick="tuitionChange(1);" name="tuitionType" value="1" />按期
						</span><span id="tuitionSpan2"><input type="radio"
							id="tuitionType2" name="tuitionType" value="2"
							onclick="tuitionChange(2);" style="width: 20px" />按次</span> <span
							id="tuitionSpan3"><input type="radio" name="tuitionType"
							value="3" id="tuitionType3" onclick="tuitionChange(3);"
							style="width: 20px" />按时间 &nbsp;</span><span id="tuitionTip">(保存后不能修改，谨慎选择)</span>
					</div>
				</div>
				<div class="divRow">
					<div style="width: 100px; float: left">
						<label for="tuition">学费标准</label>
					</div>
					<div style="display: inline">
				...
				<div class="divRow" id="classTimesDiv">
					<div style="width: 100px; float: left">
						<label for="classTimes">课时总数</label>
					</div>
					<div style="display: inline">
						<input type="text" id="classTimes" name="classTimes"
							data-options="min:0,precision:0" class="easyui-numberbox" /><span
							id="classTimesSpan">次</span>
					</div>
				</div>
				<div class="divRow" id="termDiv">
					...
					<div style="display: inline">
						<input type="text" style="width: 100px;" name="startDate"
							class="easyui-datebox" id="startDate1"
							...
							style="width: 20px" /> 日期待定
					</div>
				</div>
				<div class="none" style="margin-top: 5px;" id="timeMonthDiv">
					<div style="width: 100px; float: left">
						<label for="startDate2">开班日期</label>
					</div>
					<div style="display: inline">
						<input type="text" style="width: 100px;" name="startDate2"
							class="easyui-datebox" data-options="value:'getCurrentDate();'" /><input
							type="checkbox" name="dateUndetermined" value="1" /> 日期待定
					</div>
				</div>
				<div class="divRow">
					<div style="width: 100px; float: left">
						<label for="teacherCode">教师名称</label>
					</div>
					<div style="display: inline">
						<input type="text" id="teacherCode" name="teacherCode"
							class="easyui-combobox" />&nbsp;<label for="assistantCode">助教</label><input
							type="text" name="assistantCode" id="assistantCode"
							class="easyui-combobox" />
					</div>
				</div>
				<div class="divRow">
					<div style="width: 100px; float: left">
						<label for="classRoomCode">教室名称</label>
					</div>
					<div style="display: inline">
						<input type="text" id="classRoomCode" name="classRoomCode"
							class="easyui-combobox" />
					</div>
				</div>
				<div class="divRow">
					...
					<div style="width: 350px; height: 160px; display: inline-table;">
						<select name="TimingWeekday1" id="TimingWeekday1"
							...
							id="endTime1" name="endTime1" class="easyui-timespinner"
							...
							data-options="showSeconds:false"> &nbsp;到 &nbsp;<input
							id="endTime2" class="easyui-timespinner" name="endTime2"
							style="width: 80px;" required="required"
							...
							data-options="showSeconds:false"> &nbsp;到 &nbsp;<input
							id="endTime3" class="easyui-timespinner" name="endTime3"
							style="width: 80px;" required="required"
							...
							data-options="showSeconds:false"> &nbsp;到 &nbsp;<input
							id="endTime4" class="easyui-timespinner" name="endTime4"
							style="width: 80px;" required="required"
							...
							data-options="showSeconds:false"> &nbsp;到 &nbsp;<input
							id="endTime5" class="easyui-timespinner" name="endTime5"
							style="width: 80px;" required="required"
							...
							data-options="showSeconds:false"> &nbsp;到 &nbsp;<input
							id="endTime6" class="easyui-timespinner" name="endTime6"
							style="width: 80px;" required="required"
							...
							data-options="showSeconds:false"> &nbsp;到 &nbsp;<input
							id="endTime7" class="easyui-timespinner" name="endTime7"
							style="width: 80px;" required="required"
				...
				<div class="divRow">
					<div style="width: 100px; float: left">
						<label for="ratedNumber">额定人数</label>
					</div>
					<div style="display: inline">
						<input type="text" style="width: 100px;" name="ratedNumber"
							data-options="required:true,min:0,precision:0"
