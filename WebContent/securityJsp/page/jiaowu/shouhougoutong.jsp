				...
				<div style="margin-top: 10px;">
					<div style="margin-left: 15%;">
						...
						<input id="communicationType" class="easyui-combobox"
							...
							data-options="valueField:'communicationType',textField:'communicationTypeName',url:'getCommunicationType?type=2&flag=select',panelHeight:'auto',editable:false" />
