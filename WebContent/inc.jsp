...
%>
<%-- 引入jquery扩展 --%>
<script src="<%=contextPath%>/jslib/cxwExtJquery.js?version=<%=version%>" 	type="text/javascript" charset="utf-8"></script>
<%--引入jquery.cookie.js --%>
...
<%-- 引入easyui扩展 --%>
<script src="<%=contextPath%>/jslib/cxwExtEasyUI.js?version=<%=version%>" type="text/javascript" charset="utf-8"></script>

<%-- 引入扩展图标 --%>
<link rel="stylesheet" 	href="<%=contextPath%>/style/cxwExtIcon.css?version=<%=version%>" type="text/css">

<%-- 引入自定义样式 --%>
<link rel="stylesheet" 	href="<%=contextPath%>/style/cxwExtCss.css?version=<%=version%>" type="text/css">

<%-- 引入javascript扩展 --%>
<script src="<%=contextPath%>/jslib/cxwExtJavascript.js?version=<%=version%>" type="text/javascript" charset="utf-8"></script>

<%-- 引入自定义js --%>
<script src="<%=contextPath%>/jslib/cxwUtil.js?version=<%=version%>"  type="text/javascript" charset="utf-8"></script>
