...
<style type="text/css">
	/* 本例子css */
		...
		.slideBox .bd ul{list-style-type:none;margin:0px;padding:0px }
		.slideBox .bd li{ zoom:1; vertical-align:middle; }
		.slideBox .bd img{display:block;width:100%;height:100%  }

		/* 下面是前/后按钮代码，如果不需要删除即可 */
		.slideBox .prev,
		.slideBox .next{ position:absolute; left:3%; top:50%; margin-top:-25px; display:block; width:32px; height:40px; background:url(<%=contextPath%>/style/image/slider-arrow.png) -110px 5px no-repeat; filter:alpha(opacity=50);opacity:0.5;   }
...
<body>
	<div class="total">
			...
			<a class="next" href="javascript:void(0)"></a>
				...
				<div class="morePlatform">
					<a href="" target="_blank"><img alt="二维码" class="item-image"
							src="<%=contextPath%>/style/image/qrcode.png" > 
							</a>
							<a href="" target="_blank"><img alt="二维码" class="item-image"
							src="<%=contextPath%>/style/image/ios.png"> 
							</a>
							<a href="" target="_blank"><img alt="二维码" class="item-image"
							src="<%=contextPath%>/style/image/ipad.png"> 
							</a>
							<a href="" target="_blank"><img alt="二维码" class="item-image"
							src="<%=contextPath%>/style/image/morePlaterm.png"> 
							</a>
				</div> 
			</div>
		</div>
		...
		<div class="ft-wrapper" style="width: 980px;">
			<p>
				<strong>玩转人人</strong>
				<a target="_blank" href="http://page.renren.com/register/regGuide/">公共主页</a>
				<a target="_blank" href="http://public.renren.com/">公众平台</a>
				<a target="_blank" href="http://support.renren.com/helpcenter">客服帮助</a>
				<a target="_blank" href="http://www.renren.com/siteinfo/privacy">隐私</a>
			</p>
			<p>
				<strong>商务合作</strong>
				<a target="_blank" href="http://page.renren.com/marketing/index">品牌营销</a>
				<a class="l-2" target="_blank" href="http://bolt.jebe.renren.com/introduce.htm">中小企业<br/>自助广告</a>
				<a target="_blank" href="http://dev.renren.com/">开放平台</a>
			</p>
			<p>
				<strong>公司信息</strong>
				<a target="_blank" href="http://www.renren-inc.com/zh/product/renren.html">关于我们</a>
				<a target="_blank" href="http://page.renren.com/gongyi">人人公益</a>
				<a target="_blank" href="http://www.renren-inc.com/zh/hr/">招聘</a>
			</p>
			<p>
				<strong>友情链接</strong>
				<a target="_blank" href="http://www.jingwei.com/">经纬网</a>
				<a target="_blank" href="http://wan.renren.com/">人人游戏</a>
				<a target="_blank" href="http://fenqi.renren.com/">人人分期</a>
				<a target="_blank" href="http://quxue.renren.com/">人人趣学</a>
			</p>
			<p>
				<strong>人人移动客户端下载</strong>
				<a target="_blank" href="http://mobile.renren.com/showClient?v=platform_rr&psf=42064">iPhone/Android</a>
				<a target="_blank" href="http://mobile.renren.com/showClient?v=platform_hd&psf=42067">iPad客户端</a>
			...
			<p style="margi-left: -20px" class="copyright-info">
				...
				<span><a target="_blank" href="http://www.miibeian.gov.cn/">京ICP证090254号</a></span>
				<span>人人网&copy;2015</span>
				<span><a id="lawInfo" href="#nogo">法律声明</a></span>
			</p>
		</div>
