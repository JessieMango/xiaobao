...
public class SchoolDAOImpl implements SchoolDAO {
	...
	public int updateSchoolBySchoolCode(School school) {
		...
		SqlParameterSource paramSource = new BeanPropertySqlParameterSource(school);
	...
	public School getSchoolById(String schoolCode) {
		...
		final School result = this.npJdbcTemplate.queryForObject(sql, paramMap, new RowMapper<School>() {
			@Override
